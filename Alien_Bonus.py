# Alien_Bonus.py by Frank Mock 2016
import pygame
import random
import Constants
from Alien import *
...
class Alien_Bonus(Alien):
    ...
    def __init__(self):
        ...
        # The sound file for this Alien is in the resources dir
        self.bonus_ship_sound = pygame.mixer.Sound("resources/bonus_ship_sound.wav")
        self.timer = Timer()
        self.timer.count_down = True
        self.timer.set_start_time(240)        
         
        # The spritesheet for this Alien is in the resources dir          
        sprite_sheet = SpriteSheet("resources/bonus-ship.png")
    ...
    # Plays the sound file for this object
    def play_sound(self):
        self.bonus_ship_sound.play()
