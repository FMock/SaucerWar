# Alien_Purple by Frank Mock 2016
import pygame
import random
import Constants
from Alien import *
...
# Purple alien starts off with 4 HP
class Alien_Purple(Alien):
    ...
    def __init__(self):
        ...
        sprite_sheet = SpriteSheet("resources/purple-ship.png")
        ...
        # this alien starts off with 4 hp
        self.hitpoints = 4
        self.start_hitpoints = 4
