# Alien_Yellow.py by Frank Mock 2016
import pygame
import random
import Constants
from Alien import *
...
# This alien derives from the "Alien" class
# Yellow alien starts off with 5 HP
class Alien_Yellow(Alien):
    ...
    def __init__(self):
        ...
        # Spritesheet for this alien is in resources dir          
        sprite_sheet = SpriteSheet("resources/yellow-ship.png")
        ...
        # This alien starts with 5 HP
        self.hitpoints = 5
        self.start_hitpoints = 5
